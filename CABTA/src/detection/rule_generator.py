...
class RuleGenerator:
    ...
    @staticmethod
    def _sanitize_rule_name(value: str, prefix: str = "AISA_File") -> str:
...
status: experimental
description: Detects presence of an analyzed file based on stable file artifacts extracted by AISA
author: AISA
date: {datetime.now().strftime('%Y/%m/%d')}
references:
    - https://github.com/conglambaomat/hihi
...
# Auto-generated by AI Security Assistant - Block phishing campaign
...
# Auto-generated by AI Security Assistant
...
Reason: Phishing campaign detected by AI Security Assistant
Duration: Permanent
...
New-TransportRule -Name "BTA-Block-{sender_domain[:20] if sender_domain else 'unknown'}" `
    ...
    -Comments "Auto-generated by AI Security Assistant - Phishing campaign block"
